...
export const spalls = {
    ...
    magicalResistance: {name: "Магическое сопротивление", class: "Заклинание активатор", target: "resistance", price: 5, explanation: "Существо несущее посох получает сопротивление к урону."},
