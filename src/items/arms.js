...
export const arms = {
    simpleHandWeapons: {
        battleStaff: {name: "Боевой посох", price: 2, damage: diceRandomizer(6), property: [8]},
        mace: {name: "Булова", price: 1, damage: diceRandomizer(6), property: []},
        baton: {name: "Дубинка", price: 1, damage: diceRandomizer(4), property: ["Легкое"]},
        knife: {name: "Кинжал", price: 1, damage: diceRandomizer(4), property: ["Легкое", "Метательное", "Фехтовальное"]},
        spear: {name: "Копьё", price: 3, damage: diceRandomizer(6), property: [8, "Метательное"]},
        lightHammer: {name: "Лёгкий молот", price: 2, damage: diceRandomizer(4), property:  ["Легкое", "Метательное"]},
        propellantSpear: {name: "Метательное копьё", price: 1, damage: diceRandomizer(6), property: ["Метательное"]},
        club: {name: "Палица", price: 2, damage: diceRandomizer(8), property: ["Двуручное"]},
    ...
    simpleRangeWeapon: {
        ...
        dart: {name: "Дротик", price: 1, damage: diceRandomizer(4), property: ["Метательное", "Фехтовальное"]},
        shortBow: {name: "Короткий лук", price: 25, damage: diceRandomizer(6), property: ["Двуручное"]},
        sling: {name: "Праща", price: 1, damage: diceRandomizer(4), property: []}
    },
    militaryHandWeapons: {
        ...
        warAxe: {name: "Боевой топор", price: 10, damage: diceRandomizer(8), property: [10]},
        ...
        longSpear: {name: "Длинное копьё", price: 10, damage: diceRandomizer(12), property: ["Досягаемость"]},
